...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Poppins&family=Red+Hat+Display:wght@700&display=swap"
          rel="stylesheet">
...
<div class="container p-5">
    ...
    <h2 class="p-5 text-white d-flex flex-wrap justify-content-center">Vores Kompetencer</h2>
    ...
    <div class="row ">
        <div class="col-lg-3 col-md-6  d-flex align-content-center flex-wrap ">
            <div class="card border-light p-1 p-md-4 mb-4 mb-lg-0">
                <div class="card-body">
                    ...
                    <h5 class="mb-3 d-flex justify-content-center">Web <span class="text-primary"> Design</span></h5>
                    <p class="d-flex justify-items-center">Designed with the latest design trends in mind. Our product
        ...
        <div class="col-lg-3 col-md-6 d-flex align-content-center flex-wrap rounded-2 ">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-center">
                        <i class="fas fa-camera fa-3x text-black"></i>
                    </div>
                    <h5 class="mb-2 d-flex justify-content-center">Web <span class="text-primary"> Design</span></h5>
                    <p class="d-flex justify-items-center">Designed with the latest design trends in mind. Our product
                        feels modern, creative, and
                        beautiful.</p>
                </div>
